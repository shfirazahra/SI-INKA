...
class Konfigurasi extends CI_Controller {
    ...
    public function index()
	{
        ...
        $this->load->view('partials/sidebar', $data, FALSE);
        $this->load->view('konfigurasi', $data, FALSE);
        $this->load->view('partials/footer', $data, FALSE);
    }
    ...
    public function simpan(){
        ...
        $data = array( 'title' => 'Kantor Wilayah ATR/BPN Jawa Tengah : Konfigurasi Website', 
    ...
    public function logo(){
        ...
        $data = array('title' => 'Konfigurasi Logo Website',
                    'konfigurasi' => $konfigurasi);
         $this->load->view('partials/sidebar', $data, FALSE);
        $this->load->view('konfigurasi/logo', $data, FALSE);
        $this->load->view('partials/footer', $data, FALSE);
    }
    ...
    public function simpan_logo()
    {
        ...
        $this->load->view('partials/footer', $data, FALSE);
                ...
                redirect(base_url('konfigurasi/logo'), 'refresh');
            }
             $this->load->view('partials/sidebar', $data, FALSE);
        $this->load->view('konfigurasi/logo', $data, FALSE);
        $this->load->view('partials/footer', $data, FALSE);
    ...
    public function icon(){
        ...
        $data = array('title' => 'Konfigurasi Icon Website',
                    'konfigurasi' => $konfigurasi);
       $this->load->view('partials/sidebar', $data, FALSE);
        $this->load->view('konfigurasi_icon', $data, FALSE);
        $this->load->view('partials/footer', $data, FALSE);
    }
    ...
    public function simpan_icon()
    {
        ...
        $this->load->view('partials/footer', $data, FALSE);
                ...
                redirect(base_url('konfigurasi/icon'), 'refresh');
            }
             $this->load->view('partials/sidebar', $data, FALSE);
        $this->load->view('konfigurasi/icon', $data, FALSE);
        $this->load->view('partials/footer', $data, FALSE);
        }
    }
    ...
    public function banner(){
        ...
        $data = array('title' => 'Konfigurasi Banner Website',
                    'konfigurasi' => $konfigurasi);
         $this->load->view('partials/sidebar', $data, FALSE);
        $this->load->view('konfigurasi_banner', $data, FALSE);
        $this->load->view('partials/footer', $data, FALSE);
    }
