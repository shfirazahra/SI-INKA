...
class Pengeluaranku extends CI_Controller{
	public function __construct(){
		parent::__construct();
		date_default_timezone_set('Asia/Jakarta');
		$this->data['aktif'] = 'pengeluaranku';
		$this->load->model('M_barangc', 'm_barangc');
		$this->load->model('M_peminjamku', 'm_peminjamku');
		$this->load->model('M_pengeluaranku', 'm_pengeluaran');
		$this->load->model('M_detail_keluarku', 'm_detail_keluarku');
	}
	...
	public function index(){
		...
		$this->load->view('pengeluaranku/lihat', $this->data);
	}

	public function tambah(){
		$this->data['title'] = 'Tambah Transaksi';
		$this->data['all_barang'] = $this->m_barang->lihat_stok();
		$this->data['all_peminjam'] = $this->m_peminjam->lihat_cst();
