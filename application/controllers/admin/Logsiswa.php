...
class Logsiswa extends CI_Controller {
    
    function __construct() {
        parent::__construct();
        $this->load->model('logsiswa_model');
    ...
    public function index(){
        $logsiswa = $this->logsiswa_model->get_all('logsiswa');
         
        $data = array ('title'=>'Data Login Siswa', 
            'logsiswa'=>$logsiswa);
        $this->load->view('admin/nav', $data, FALSE);
        $this->load->view('admin/logsiswa', $data, FALSE);
    ...
    public function update_produk($id_kategori = null){
    //Ambil data
   
    $produk['tb_bimbel'] = $this->db->get('tb_bimbel');
    $produk = $this->load->model('siswa_model');
    $kategori = $this->load->model('Kategori_model');
