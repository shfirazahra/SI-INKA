...
class Logguru extends CI_Controller {
    
    function __construct() {
        parent::__construct();
        $this->load->model('logguru_model');
    ...
    public function index(){
        $logguru = $this->logguru_model->get_all('logguru');
         
        $data = array ('title'=>'Data Login Guru', 
            'logguru'=>$logguru);
        $this->load->view('admin/nav', $data, FALSE);
        $this->load->view('admin/logguru', $data, FALSE);
