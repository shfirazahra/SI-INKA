...
class Penerimaanku extends CI_Controller{
	public function __construct(){
		parent::__construct();
		date_default_timezone_set('Asia/Jakarta');
		$this->data['aktif'] = 'penerimaanku';
		...
		$this->load->model('M_detail_terimaku', 'm_detail_terimaku');
	}

	public function index(){
		$this->data['title'] = 'Transaksi Penerimaan';
		$this->data['all_penerimaan'] = $this->m_penerimaanku->lihat();
		$this->data['no'] = 1;

		$this->load->view('penerimaanku/lihat', $this->data);
	}
