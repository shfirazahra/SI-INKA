			...
			<div id="content" data-url="<?= base_url('penerimaan') ?>">
				...
				<div class="clearfix">
					...
					<div class="float-right">
						<a href="<?= base_url('penerimaan/export_detail/' . $penerimaan->no_terima) ?>" target="_blank" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Export</a>
									...
									<tbody>
										<?php foreach ($all_detail_terima as $detail_terima): ?>
											<tr>
												...
												<td><?= $detail_terima->jumlah ?></td>
												<td><?= $detail_terima->ruangan ?></td>
