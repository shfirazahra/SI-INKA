								...
								<form action="<?= base_url('barang/proses_tambah') ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="number" name="jumlah" placeholder="Masukkan Stok" autocomplete="off"  class="form-control" required>
										</div>
										<div class="form-group col-md-6">
											<label for="ruangan"><strong>Ruangan</strong></label>
											<input type="text" name="ruangan" placeholder="Masukkan Nama Barang" autocomplete="off"  class="form-control" required>
										</div>
					
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="kondisi"><strong>Keterangan</strong></label>
											<input type="text" name="kondisi" placeholder="Masukkan Keterangan" autocomplete="off"  class="form-control">
										</div>
									</div>
									<hr>
