			...
			<div id="content" data-url="<?= base_url('pimpinan') ?>">
				...
				<div class="clearfix">
					...
					<div class="float-right">
						<a href="<?= base_url('pimpinan') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div>
				</div>
				<hr>
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('pegawai/proses_ubah/' . $petugas->id) ?>" id="form-tambah" method="POST">
									<div class="form-row">
