			...
			<div id="content" data-url="<?= base_url('pengeluaran') ?>">
				...
				<div class="clearfix">
					...
					<div class="float-right">
						<a href="<?= base_url('pengeluaran/export_detail/' . $pengeluaran->no_keluar) ?>" target="_blank" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Export</a>
							...
							<div class="col-md-6">
								<table class="table table-borderless">
									...
									<tr>
										...
										<td>:</td>
										<td><?= $pengeluaran->tanggal_kembali ?> - <?= $pengeluaran->tanggal_kembali?></td>
									</tr>
									...
									<tbody>
										<?php foreach ($all_detail_keluar as $detail_keluar): ?>
											<tr>
												...
												<td><?= $detail_keluar->ruangan ?></td>
												<td><?= $detail_keluar->kondisi ?></td>
												<td><?= $detail_keluar->tanggal_kembali ?></td>
											</tr>
										<?php endforeach ?>
									</tbody>
								</table>
