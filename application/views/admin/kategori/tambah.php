								...
								<form action="<?= base_url('kategori/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="id_kategori"><strong>id_kategori</strong></label>
											<input type="text" name="id_kategori" placeholder="Masukkan ID Kategori" autocomplete="off"  class="form-control" required value="<?= mt_rand(10000000, 99999999) ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
											<label for="nama_kategori"><strong>Nama Barang</strong></label>
