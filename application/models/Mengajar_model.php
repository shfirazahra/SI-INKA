...
class Mengajar_model extends CI_Model {
    ...
    function user($id_user){
        $this->db->select('header_transaksi.*, tb_databarang.nama_bimbel, transaksi.jumlah, transaksi.total_harga');
        $this->db->from('header_transaksi');
        ...
        $this->db->join('tb_databarang', 'tb_databarang.kode_bimbel = transaksi.kode_bimbel', 'left');
    ...
    function get_all(){
        $this->db->select('transaksi.*,users.nama,tb_databarang.nama_bimbel, tb_databarang.nama_guru, tb_databarang.jadwal, header_transaksi.alamat, header_transaksi.telepon');
        $this->db->from('transaksi');
